...
Language.create(name: 'Afrikanns', code: 'AF')
...
Language.create(name: 'Chinese (Mandarin)', code: 'ZH')
Language.create(name: 'Croation', code: 'HR')
...
Language.create(name: 'Ukranian', code: 'UK')
